...
client1.photo.attach(io: URI.open(Cloudinary::Utils.cloudinary_url("https://res.cloudinary.com/dxljoz6af/image/upload/v1721388471/jane_smith_jf19ib.jpg", size: '300x300', format: 'png')), filename: 'avatar.png')
puts "Created #{client1}!"

client2 = Client.create!(lineid: "XYZ5678", phone_number: "555-0102", name: "Bob Smith", nickname: "BobS2")
client2.photo.attach(io: URI.open(Cloudinary::Utils.cloudinary_url("https://res.cloudinary.com/dxljoz6af/image/upload/v1721389003/download_xpmy4i.jpg", size: '300x300', format: 'png')), filename: 'avatar.png')
puts "Created #{client2}!"

client3 = Client.create!(lineid: "LMN9101", phone_number: "555-0103", name: "Charlie Brown", nickname: "CharlieB3")
client3.photo.attach(io: URI.open(Cloudinary::Utils.cloudinary_url("https://res.cloudinary.com/dxljoz6af/image/upload/v1721389002/download_17_qasdmi.jpg", size: '300x300', format: 'png')), filename: 'avatar.png')
puts "Created #{client3}!"

client4 = Client.create!(lineid: "DEF2345", phone_number: "555-0104", name: "Diana Ross", nickname: "DianaR4")
client4.photo.attach(io: URI.open(Cloudinary::Utils.cloudinary_url("https://res.cloudinary.com/dxljoz6af/image/upload/v1721389003/download_19_eeri0z.jpg", size: '300x300', format: 'png')), filename: 'avatar.png')
puts "Created #{client4}!"

client5 = Client.create!(lineid: "GHI6789", phone_number: "555-0105", name: "Edward White", nickname: "EdwardW5")
client5.photo.attach(io: URI.open(Cloudinary::Utils.cloudinary_url("https://res.cloudinary.com/dxljoz6af/image/upload/v1721389001/download_13_ach1fx.jpg", size: '300x300', format: 'png')), filename: 'avatar.png')
puts "Created #{client5}!"

client6 = Client.create!(lineid: "JKL0123", phone_number: "555-0106", name: "Fiona Green", nickname: "FionaG6")
client6.photo.attach(io: URI.open(Cloudinary::Utils.cloudinary_url("https://res.cloudinary.com/dxljoz6af/image/upload/v1721389001/download_12_s3mq6f.jpg", size: '300x300', format: 'png')), filename: 'avatar.png')
puts "Created #{client6}!"

client7 = Client.create!(lineid: "MNO4567", phone_number: "555-0107", name: "George Black", nickname: "GeorgeB7")
client7.photo.attach(io: URI.open(Cloudinary::Utils.cloudinary_url("https://res.cloudinary.com/dxljoz6af/image/upload/v1721388991/download_10_osrm3v.jpg", size: '300x300', format: 'png')), filename: 'avatar.png')
puts "Created #{client7}!"

client8 = Client.create!(lineid: "PQR8901", phone_number: "555-0108", name: "Hannah Blue", nickname: "HannahB8")
client8.photo.attach(io: URI.open(Cloudinary::Utils.cloudinary_url("https://res.cloudinary.com/dxljoz6af/image/upload/v1721389002/download_15_scg5fl.jpg", size: '300x300', format: 'png')), filename: 'avatar.png')
puts "Created #{client8}!"

client9 = Client.create!(lineid: "STU2345", phone_number: "555-0109", name: "Ian Gray", nickname: "IanG9")
client9.photo.attach(io: URI.open(Cloudinary::Utils.cloudinary_url("https://res.cloudinary.com/dxljoz6af/image/upload/v1721389002/download_14_ppqbeb.jpg", size: '300x300', format: 'png')), filename: 'avatar.png')
puts "Created #{client9}!"

client10 = Client.create!(lineid: "VWX6789", phone_number: "555-0110", name: "Jane White", nickname: "JaneW10")
client10.photo.attach(io: URI.open(Cloudinary::Utils.cloudinary_url("https://res.cloudinary.com/dxljoz6af/image/upload/v1721388990/download_7_xu1g2a.jpg", size: '300x300', format: 'png')), filename: 'avatar.png')
puts "Created #{client10}!"

# Joel's seeds

start_date = Date.new(2024, 8, 26) # Monday of the week
end_date = start_date + 3 # thrusday of the week
...
start_date = Date.new(2024, 9, 2) # Monday of the week
end_date = start_date + 3 # thrusday of the week
...
# Create Bookings
booking1 = Booking.create!(
  start_time: DateTime.new(2024, 9, 2, 8, 0, 0), # Example time slot within the availability
  end_time: DateTime.new(2024, 9, 2, 9, 0, 0),
  status: 1, # Assuming 1 corresponds to a status like 'confirmed'
  user_id: joel.id,
  client_id: client1.id,
  title: 'Consultation with Alice',
...
booking2 = Booking.create!(
  start_time: DateTime.new(2024, 9, 2, 9, 0, 0), # Example time slot within the availability
  end_time: DateTime.new(2024, 9, 2, 10, 0, 0),
  status: 1,
  user_id: joel.id,
  client_id: client2.id,
  title: 'Consultation with Bob',
...
booking3 = Booking.create!(
  start_time: DateTime.new(2024, 9, 28, 10, 0, 0), # Example time slot within the availability
  end_time: DateTime.new(2024, 9, 28, 11, 0, 0),
  status: 1,
  user_id: joel.id,
  client_id: client3.id,
  title: 'Consultation with Charlie',
...
booking4 = Booking.create!(
  start_time: DateTime.new(2024, 9, 5, 13, 0, 0), # Example time slot within the availability
  end_time: DateTime.new(2024, 9, 5, 14, 0, 0),
  status: 1,
  user_id: joel.id,
  client_id: client4.id,
  title: 'Consultation with Diana',
...
booking7 = Booking.create!(
  start_time: DateTime.new(2024, 9, 4, 16, 0, 0), # Example time slot within the availability
  end_time: DateTime.new(2024, 9, 4, 17, 0, 0),
  status: 1,
  user_id: joel.id,
  client_id: client7.id,
  title: 'Consultation with George',
...
booking8 = Booking.create!(
  start_time: DateTime.new(2024, 9, 5, 17, 0, 0), # Example time slot within the availability
  end_time: DateTime.new(2024, 9, 5, 18, 0, 0),
  status: 1,
  user_id: joel.id,
  client_id: client8.id,
  title: 'Consultation with Hannah',
...
booking9 = Booking.create!(
  start_time: DateTime.new(2024, 9, 3, 8, 0, 0), # Example time slot on the next day
  end_time: DateTime.new(2024, 9, 3, 9, 0, 0),
  status: 1,
  user_id: joel.id,
  client_id: client9.id,
  title: 'Consultation with Ian',
...
booking10 = Booking.create!(
  start_time: DateTime.new(2024, 9, 3, 9, 0, 0), # Example time slot on the next day
  end_time: DateTime.new(2024, 9, 3, 10, 0, 0),
  status: 1,
  user_id: joel.id,
  client_id: client10.id,
  title: 'Consultation with Jane',
